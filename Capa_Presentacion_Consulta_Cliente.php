...
<table width="1127" height="300" border="0" align="center">
  ...
  <tr>
    ...
    <center>
    <fieldset>
<legend>Consultar por nombre de cliente</legend>

   <form action="Capa_Presentacion_Tabla_Cliente.php" method="post"> 
    <table width="289" border="0">
      <tr>
        <td height="81" colspan="2"><table width="289" border="0">
          <tr>
            <label id="oculto" hidden="">Ingrese Nombre de cliente</label>
            <br/>
          </tr>
          <tr>
            <td width="47"><label for="NombreC"></label></td>
            <td colspan="2"><input type="text" name="NombreC" id="NombreC" autofocus placeholder="Nombre cliente" title="Nombre de cliente" required/></td>
          </tr>
          <tr>
            <td rowspan="2">&nbsp;</td>
          ...
          <tr>
            <td><input type="submit" name="btnNombreC" id="btnNombreC" value="Consultar" /></td>
            <br />
          </tr>
