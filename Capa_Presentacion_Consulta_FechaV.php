...
<center>    
<fieldset>
<legend>Consultar ventas por fecha</legend>

   <form action="Capa_Presentacion_Tabla_FechaV.php" method="post"> 
    <table width="289" border="0">
      <tr>
        <td height="81" colspan="2"><table width="289" border="0">
          <tr>
            <label id="oculto" hidden="">Ingrese fecha a buscar</label>
            <br/>
          </tr>
          <tr>
            <td width="47"><label for="FechaV"></label></td>
            <td colspan="2"><p>     
                <input type="Date" name="FechaV" autofocus value="1" id="FechaV" required/>     
              <br />
            </p></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><input type="submit" name="btnFechaV" id="btnFechaV" value="Consultar" /></td>
            <br />
          </tr>
